...
const Newsletter = () => {
    return (
        <div className="container mx-auto xl:flex xl:justify-end py-16">
            <div className="container sm:mx-auto">
                <div className="block xl:flex justify-between xl:items-center lg:items-center md:flex">
                    <div className="w-11/12 xl:w-4/12 mx-auto xl:mx-16 md:w-5/12">
                        <h1 className="text-gray-800 text-3xl font-semibold mb-3 pt-12 xl:pt-0">
                            ...
                            <div className="w-full">
                                <div className="flex flex-col mb-3">
                                    ...
                                    <input
                                        type="email"
                                        id="email"
                                        placeholder="support@creditklick.com"
                                        className="focus:outline-none focus:border-indigo-700 border-gray-300 border rounded-sm py-2 outline-none pl-2 pr-2"
                                    />
                                </div>
                                <button
                                    type="submit"
                                    className="focus:outline-none bg-indigo-700 hover:bg-indigo-600 text-white text-base w-auto py-2 px-4 rounded-lg"
                                >
