            ...
            <div className="container mx-auto max-w-7xl px-4 py-10 mb-10">
                ...
                >
                    ...
                    <p className="text-base md:text-lg text-gray-700 mb-8 leading-relaxed">
                        Our credit score check service is provided in partnership with Experian. The credit score and report
                        displayed are for informational purposes only. We do not guarantee the accuracy of the information
                    ...
                    <p className="text-base md:text-lg text-gray-700 mb-8 leading-relaxed">
                        ...
                        <a href="mailto:legal@creditklick.com" className="text-blue-600 hover:underline">legal@creditklick.com</a>
                    </p>
